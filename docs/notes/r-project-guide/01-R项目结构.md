...
在软件中心安装 rstudio，4.4.1版本r以及Rtools<br>
![alt text](image-13.png)![alt text](image-16.png)

如果安装多个版本的R，可以在如下文件夹看到电脑中安装的R版本。<br>
![alt text](image-21.png)

运行本项目需保证打开Rstuido是默认R版本为4.4.1，设置方式如下图。<br>
![alt text](image-31.png)

从远程桌面打开Rproject文件<br>
